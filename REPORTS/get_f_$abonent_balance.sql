...
/*
  ...
  Purpose : ‘ункци€ дл€ определени€ баланса абонента M2000
  Version : 1.1.02
  HISTORY
  User    : Date         : Description
  -------------------------------------------------------------------------------------------------
  V.ERIN    25.03.2015     —оздание 
  -------------------------------------------------------------------------------------------------
  V.ERIN    17.10.2015     ƒобавлен предел долга 
  -------------------------------------------------------------------------------------------------
*/
   v_retval  number := 0;
   v_balance number := 0;
